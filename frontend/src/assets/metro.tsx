...
export const lineAndIcon: Record<Line, JSX.Element> = {
  ...
  "2": (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["2"]}>
      
    </Text>
  ),
  "3": (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["3"]}>
      
    </Text>
  ),
  "4": (
  ...
  "5": (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["5"]}>
      
    </Text>
  ),
  6: (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["6"]}>
      
    </Text>
  ),
  "7": (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["7"]}>
      
    </Text>
  ),
  "8": (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["8"]}>
      
    </Text>
  ),
  "8А": (
  ...
  "9": (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["9"]}>
      
    </Text>
  ),
  "10": (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["10"]}>
      
    </Text>
  ),
  "11": (
  ...
  "12": (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["12"]}>
      
    </Text>
  ),
  "13": (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["13"]}>
      
    </Text>
  ),
  "14": (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["14"]}>
      
    </Text>
  ),
  МЦК: (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["МЦК"]}>
      
    </Text>
  ),
  "15": (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["15"]}>
      &#xe90c;
    </Text>
  ),
  Л1: (
  ...
  Д1: (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["Д1"]}>
      
    </Text>
  ),
  Д2: (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["Д2"]}>
      
    </Text>
  ),
  Д3: (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["Д3"]}>
      
    </Text>
  ),
  Д4: (
    <Text fontFamily={"IcoMoon"} size={14} color={lineAndColor["Д4"]}>
      
    </Text>
  ),
};
